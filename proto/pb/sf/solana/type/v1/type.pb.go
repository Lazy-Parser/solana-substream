...
const file_sf_solana_type_v1_type_proto_rawDesc = "" +
	"\n" +
	"\x1csf/solana/type/v1/type.proto\x12\x11sf.solana.type.v1\"\x8f\x03\n" +
	"\x05Block\x12-\n" +
	...
	"\x10readonly_indexes\x18\x03 \x01(\fR\x0freadonlyIndexes\"\x91\a\n" +
	...
	"\x12inner_instructions\x18\x05 \x03(\v2$.sf.solana.type.v1.InnerInstructionsR\x11innerInstructions\x126\n" +
	"\x17inner_instructions_none\x18\n" +
	" \x01(\bR\x15innerInstructionsNone\x12!\n" +
	"\flog_messages\x18\x06 \x03(\tR\vlogMessages\x12*\n" +
	"\x11log_messages_none\x18\v \x01(\bR\x0flogMessagesNone\x12M\n" +
